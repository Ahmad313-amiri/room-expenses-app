...
const GroupModelSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'GroupSettings': GroupSettingsSchema},
...
int _groupModelEstimateSize(
  ...
  bytesCount += 3 +
      GroupSettingsSchema.estimateSize(
          object.settings, allOffsets[GroupSettings]!, allOffsets);
  return bytesCount;
}
...
extension GroupModelQueryFilter
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> currencyMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension GroupModelQueryObject
    on QueryBuilder<GroupModel, GroupModel, QFilterCondition> {
  QueryBuilder<GroupModel, GroupModel, QAfterFilterCondition> settings(
      FilterQuery<GroupSettings> q) {
    return QueryBuilder.apply(this, (query) {
...
extension GroupModelQuerySortBy
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterSortBy> sortByCurrency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currency', Sort.asc);
    });
  }

  QueryBuilder<GroupModel, GroupModel, QAfterSortBy> sortByCurrencyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GroupModelQuerySortThenBy
  ...
  QueryBuilder<GroupModel, GroupModel, QAfterSortBy> thenByCurrency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currency', Sort.asc);
    });
  }

  QueryBuilder<GroupModel, GroupModel, QAfterSortBy> thenByCurrencyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currency', Sort.desc);
    });
  }
...
extension GroupModelQueryWhereDistinct
  ...
  QueryBuilder<GroupModel, GroupModel, QDistinct> distinctByCurrency(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension GroupModelQueryProperty
  ...
  QueryBuilder<GroupModel, String, QQueryOperations> currencyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GroupModel, GroupSettings, QQueryOperations> settingsProperty() {
    return QueryBuilder.apply(this, (query) {
...
const GroupSettingsSchema = Schema(
  name: r'GroupSettings',
  id: 5569346981606042832,
  properties: {
    r'allowInvites': PropertySchema(
      id: 0,
      name: r'allowInvites',
      type: IsarType.bool,
    ),
    r'defaultSplitMethod': PropertySchema(
      id: 1,
      name: r'defaultSplitMethod',
      type: IsarType.string,
    ),
  ...
  estimateSize: _groupSettingsEstimateSize,
  serialize: _groupSettingsSerialize,
  deserialize: _groupSettingsDeserialize,
  deserializeProp: _groupSettingsDeserializeProp,
);

int _groupSettingsEstimateSize(
  GroupSettings object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  bytesCount += 3 + object.defaultSplitMethod.length * 3;
...
void _groupSettingsSerialize(
  GroupSettings object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  writer.writeBool(offsets[0], object.allowInvites);
  writer.writeString(offsets[1], object.defaultSplitMethod);
  writer.writeStringList(offsets[2], object.expenseCategories);
}

GroupSettings _groupSettingsDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = GroupSettings();
  object.allowInvites = reader.readBool(offsets[0]);
  object.defaultSplitMethod = reader.readString(offsets[1]);
  object.expenseCategories = reader.readStringList(offsets[2]) ?? [];
  return object;
}

P _groupSettingsDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension GroupSettingsQueryFilter
    on QueryBuilder<GroupSettings, GroupSettings, QFilterCondition> {
  QueryBuilder<GroupSettings, GroupSettings, QAfterFilterCondition>
      allowInvitesEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'allowInvites',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<GroupSettings, GroupSettings, QAfterFilterCondition>
      defaultSplitMethodEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'defaultSplitMethod',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<GroupSettings, GroupSettings, QAfterFilterCondition>
      defaultSplitMethodContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'defaultSplitMethod',
        value: value,
  ...
  QueryBuilder<GroupSettings, GroupSettings, QAfterFilterCondition>
      defaultSplitMethodMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'defaultSplitMethod',
        wildcard: pattern,
...
extension GroupSettingsQueryObject
    on QueryBuilder<GroupSettings, GroupSettings, QFilterCondition> {}
